...
class DataIngestor:
    ...
    def insert_market_metrics_data(self, data):
    ...
    def insert_trading_metrics(
        self, strategy_name, metric_name, value, parameters=None
    ):
        ...
        self.cursor.execute(
            query, (datetime.now(), strategy_name, metric_name, value, parameters)
        )
        self.conn.commit()
