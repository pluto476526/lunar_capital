...
urlpatterns = [
    ...
    path("fx/<str:symbol>/", views.fx_details_view, name="fx_details"),
    path("crypto/<str:symbol>/", views.crypto_details_view, name="crypto_details"),
    path("stocks/<str:symbol>/", views.stock_details_view, name="stock_details"),
